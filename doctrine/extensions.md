...
Beberlei DoctrineExtension brings to Doctrine useful SQL function like maths and dates. See https://github.com/beberlei/DoctrineExtensions
...
Now let's add the components to `config/packages/doctrine.yml` (you can choose to only add the ones you want) 
```yml
orm:
  dql:
      datetime_functions:
...
Now you can use ROUND, CEIL and other SQL functions in your Doctrine queries.
